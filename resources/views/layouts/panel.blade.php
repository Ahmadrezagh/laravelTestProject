    ...
    <div class="main-sidebar main-sidebar-sticky side-menu">
        ...
        <div class="main-sidebar-body">
            <ul class="nav">
                ...
                @endif
                @if ((Auth::user()->isAdmin() && Auth::user()->can('Products')) || Auth::user()->isSuperAdmin() )
                <li class="nav-item">
                    <a class="nav-link with-sub" href="#0">
                        <span class="shape1"></span>
                        <span class="shape2"></span>
                    ...
                    <ul class="nav-sub">
                        <li class="nav-sub-item">
                            <a class="nav-sub-link" href="{{route('products.index')}}">Products list</a>
                        </li>
                    </ul>
                </li>
                @endif
        ...
        <div class="container-fluid">
            ...
            <div class="main-header-center">
                <div class="responsive-logo">
                    <a href="{{route('home')}}"><img src="{{url('panel/assets/img/brand/logo.png')}}" class="mobile-logo" alt="logo"></a>
                    <a href="{{route('home')}}"><img src="{{url('panel/assets/img/brand/logo-light.png')}}" class="mobile-logo-dark" alt="logo"></a>
                </div>
            </div>
