                ...
                <div class="col-sm-12 col-xs-12">
                    <article id="post-433" class="post-433 page type-page status-publish hentry">
                        <div class="entry-content">
                            ...
                            <div class="vc_row wpb_row vc_row-fluid vc_custom_1496984864421">
                                <div class="wpb_column vc_column_container vc_col-sm-4">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="contact-us-left ">
                                                <h2 class="title-bar-medium-left inner-sub-title"
                                                    style="color:#111111; font-size:30px;">
                                                    Information
                                                </h2>
                                                <ul>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-8">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div role="form" class="wpcf7" id="wpcf7-f277-p433-o1" lang="en-US"
                                                 dir="ltr">
                                                ...
                                                <form action="{{route('contact.store')}}"
                                                    ...
                                                    <div class="contact-us-right">
                                                        <h2 class="title-bar-medium-left inner-sub-title">Send Us A
                                                            Massege</h2>
                                                        <div class="contact-form">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <span class="wpcf7-form-control-wrap text-917"><input
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <span class="wpcf7-form-control-wrap email-423"><input
                                                                                    required
                                                                                    ...
                                                                                    data-temp-mail-org="0"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <span class="wpcf7-form-control-wrap text-439"><input
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <span class="wpcf7-form-control-wrap textarea-463"><textarea
                                                                                    name="message" cols="20"
                                                                                    rows="6"
                                                                                    class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form-control"
                                                                                    aria-required="true"
                                                                                    aria-invalid="false"
                                                                                    placeholder="Massege*" required></textarea></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-sm-12">
                                                                    <div class="form-group margin-bottom-none">
                                                                        <button id="submitButton" type="submit" class="btn btn-danger">Submit</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
