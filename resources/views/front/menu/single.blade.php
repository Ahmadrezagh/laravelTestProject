                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 leftside-container">
                    ...
                    <div class="single-menu-inner fmp-col-md-12 fmp-col-lg-12 fmp-col-sm-12 fmp-images no-padding-lr">
                        ...
                        <div class="row">
                            ...
                            @if(!is_null($product->ingredients) && is_array(json_decode($product->ingredients)))
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="ingredients-box">
                                    <h3>Ingredients</h3>
                                    <ul>
                                        @foreach(json_decode($product->ingredients) as $ingredient)
                                        <li><i class="fa fa-check" aria-hidden="true"></i>{{$ingredient}}</li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            @endif
                            @if(!is_null($product->nutrition) && is_array(json_decode($product->nutrition)))
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="ingredients-box">
                                    <h3>Nutrition</h3>
                                    <ul>
                                        @foreach(json_decode($product->nutrition) as $nutritionItem)
                                        <li><i class="fa fa-check" aria-hidden="true"></i>{{$nutritionItem}}</li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            ...
                            @foreach($latestProducts as $sideBarLatestProductItem)
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>
                                            <a href="{{$sideBarLatestProductItem->page_url}}">{{$sideBarLatestProductItem->name}}</a>
                                        </h4>
